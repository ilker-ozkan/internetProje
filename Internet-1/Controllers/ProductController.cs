...
namespace Internet_1.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Add(ProductModel model, IFormFile Image)
        {
            ...
            if (Image != null && Image.Length > 0)
            {
                ...
                product.ImageUrl = "/images/" + uniqueFileName; // Veritabanında saklanacak URL
            }
